...
def show_predict_page():
    ...
    st.markdown("<h1 style='text-align: center; color: DarkGoldenRod;'>ImpliDraft</h1>", unsafe_allow_html=True)
    st.markdown("<h2 style='text-align: center; color: DarkGreen;'> Cloud-powered Serverless Platform for Real-time Tractor Draft Prediction </h2>", unsafe_allow_html=True)
